...
- Per specific mail folder: You can right-click any folder as the original user, click Permissions, then assign a specific folder to the user. PS: This makes it so that you HAVE to get individual folders within Gsoc2.
